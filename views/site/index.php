...
<section class='home'>
    ...
    <h1 class="moto">Empowering people,<br/>overcoming challenges.</h1>
    ...
    <article class="container card-box">
        <div class="menu-card">
            ...
            <a href=<?= Url::to(['site/about'])?>>
                <button class="button more-button" type="button" name="button">More</button>
            </a>
        </div>
        <div class="menu-card">
            <h1>the mun</h1>
