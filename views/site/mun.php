            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-wrap">
                        ...
                        <div class="modal-body modal-delimiter">
                            <h3 class="modal-title"><?= Yii::t('app', 'Schedules')?></h3>
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Wednesday (November 2nd)')?> </h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Thursday (November 3th)')?> </h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Friday (November 4th)')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Saturday (November 5th)')?> </h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Sunday (November 6th)')?></h4>
                            <p class="modal-text">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-wrap"<br/>
                        ...
                        <div class="modal-body modal-delimiter">
                            <h3 class="modal-title"><?= Yii::t('app', 'General Policies')?></h3>
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Dress code')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Delegations')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Head delegates')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Country Assignments')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Delegate fee')?></h4>
                            <p class="modal-text">
                                <?= Yii::t('app', 'A fee per person of R$ 130 in full amount or R$ 140 divided in two installments applies in order to participate in the conference. Head delegates will have the chance to choose in the registration form whether their delegations will pay their corresponding delegate fees in two installments or in full amount. The payment method chosen necessarily applies to all members of your delegation. Head delegates are responsible for gathering the money of their delegations and sending the payment to UFRGSMUN.')?>
                            </p>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Special Circumstances')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Refunds')?></h4>
                            <p class="modal-text">
                                <?= Yii::t('app', 'Registration fees are non-refundable.')?>
                            </p>
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Suspension Policy')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Valuables')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Committee Session Policy')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Certificate of Participation')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Transportation')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Official Accommodation')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Other Rules')?></h4>
                            <p class="modal-text">
                            ...
                            <h4 class="modal-subtitle"><?= Yii::t('app', 'Exceptions')?></h4>
                            <p class="modal-text">
